"""
ONNX Export Script for PointNet/PointNet++ Semantic Segmentation Models
...
def parse_args():
    parser = argparse.ArgumentParser('ONNX Export for Semantic Segmentation')
    parser.add_argument('--model', type=str, required=True,
                        help='model name (e.g., pointnet_sem_seg, pointnet2_sem_seg)')
    parser.add_argument('--checkpoint', type=str, required=True,
                        help='path to checkpoint file (.pth)')
    parser.add_argument('--num_classes', type=int, default=13,
                        help='number of semantic classes (default: 13 for S3DIS)')
...
def export_to_onnx(args):
    ...
    classifier = model_module.get_model(args.num_classes)
    ...
    if args.output_path is None:
        ...
        output_filename = f"{args.model}_c{args.num_classes}_n{args.num_point}.onnx"
